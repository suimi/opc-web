...
abstract public class JCustomOpc {
   ...
   * Connect to server
   *
   * @throws javafish.clients.opc.exception.ConnectivityException
   */
   ...
   *
   * @throws javafish.clients.opc.exception.CoInitializeException
   */
   ...
   *
   * @throws javafish.clients.opc.exception.CoUninitializeException
   */
