...
public class JOpc extends JCustomOpc implements Runnable {
   ...
   * @param group OpcGroup
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.UnableAddGroupException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.UnableAddItemException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.UnableRemoveGroupException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.UnableRemoveItemException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.SynchReadException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.SynchWriteException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.Asynch10ReadException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.Asynch20ReadException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.Asynch10UnadviseException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.Asynch20UnadviseException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.GroupUpdateTimeException
   */
   ...
   *
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.GroupActivityException
   */
   ...
   * 
   * @throws javafish.clients.opc.exception.ComponentNotFoundException
   * @throws javafish.clients.opc.exception.ItemActivityException
   */
